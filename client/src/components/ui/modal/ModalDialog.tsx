  ...
  return (
    <ModalBase dismissDisabled={dismissDisabled}>
      ...
      <div className="modal__box__buttons">
        <Button onClick={onButtonClick} text={button1Label} btnClass="modal__box__buttons--yes" />
        {showButton2 && button2Label !== undefined && (
          <Button onClick={() => dispatch(dismissModal())} text={button2Label} btnClass="modal__box__buttons--no" />
        )}
      </div>
    </ModalBase>
  );
