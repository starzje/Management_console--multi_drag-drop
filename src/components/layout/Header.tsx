...
import {
  changeLobbyType,
  lobbyTypeSelector,
} from "../../redux/features/gameTypeSlice";
        ...
        <div className="btn__switch">
          <Button
            ...
            btnClass={`btn__switch__casino  ${
              lobbyIsType === LobbyType.liveCasino
                ? "btn__switch__casino--active"
                : ""
            }`}
          ...
          <Button
            onClick={handleChangeGameType}
            text="E-igre"
            btnClass={`btn__switch__games  ${
              lobbyIsType === LobbyType.eIgre
                ? "btn__switch__games--active"
                : ""
            }`}
