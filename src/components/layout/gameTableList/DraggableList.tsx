...
import { eIgreGamesSelector, gamesSelector, liveCasinoGamesSelector, reorderGameList, reorderMultipleGames } from "../../../redux/features/gameSlice";
import { lobbyTypeSelector } from "../../../redux/features/gameTypeSlice";
import { deselectAll, selectMultipleGames, toggleMultiSelectionInGroup, toggleSelection, toggleSelectionInGroup } from "../../../redux/features/multiSelectSlice";
import { useDispatch } from "react-redux";
import { AppDispatch } from "../../../redux/store";
import { wasMultiSelectKeyUsed, wasToggleInSelectionGroupKeyUsed } from "../../../helpers/wasKeyUsed";
...
const DraggableList = () => {
    ...
    const toggleMultiSelectGroup = (event: React.MouseEvent | React.KeyboardEvent, selectedGameID: string) => {
    ...
    const performClickAction = (event: React.MouseEvent | React.KeyboardEvent, selectedGameID: string,) => {
